...
| `sensor.dc_out1_spannung` | 1–2 | Ausgang OUT1 Spannung V (÷10) |
| `sensor.dc_out1_strom` | 3–4 | Ausgang OUT1 Strom A (÷100) |
| `sensor.dc_out2_spannung` | 7–8 | Ausgang OUT2 Spannung V (÷10) |
| `sensor.dc_out2_strom` | 9–10 | Ausgang OUT2 Strom A (÷10) |

### PV-Eingang (DP 101, nur tagsüber)
| Entität | Bytes | Beschreibung |
|---|---|---|
| `sensor.pv1_leistung` | 5–6 | PV-Eingang 1 Leistung W |
| `sensor.pv1_spannung` | 1–2 | PV-Eingang 1 Spannung V (÷10) |
| `sensor.pv2_leistung` | 11–12 | PV-Eingang 2 Leistung W |

### Energie-Zähler (Lifetime)
| Entität | DP | Beschreibung |
|---|---|---|
| `sensor.pv_ertrag_gesamt` | 37 | PV-Ertrag gesamt kWh (÷100) |
...
| `number.entladeleistung_slot_1` | 106 | Entladeleistung Slot 1 in W (0–700, Schritt 10) |
| `number.entladetiefe` | 107 | Entladetiefe (DoD) in % (1–100) |
| `number.abschaltschwelle` | 108 | Mindest-Ausgangsleistung (Abschaltschwelle) W |
| `number.wr_ausgangsleistung` | 115 | Wechselrichter-Sollleistung W (0–600) |
...
| 108 | `batt_on_threshold` | integer | W | ×1 | ✅ |
...
Byte 6–7: Max. WR-Leistung in W (z.B. 600 für HM-600)
```

Bekannte Modellcodes: HM-600→1004, HM-800→1006, HM-1500→1012, HM-2250→1019, HMT-2250-6T→1028, Deye SUN600G3→2001
...
- Dieses Repo ergänzt die Arbeit von Hofyyy um eine funktionierende tuya-local YAML-Konfiguration mit:
  ...
  - Bestätigte Einheiten und Skalierungen (kWh ÷100, Temperatur ÷10)
  - DP 115 als schreibbarer Number-Entity
